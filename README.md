...
| `S3_ENDPOINT`                             | S3 internal endpoint URL (for backend)                    | For file uploads                      | `http://minio:9000`                                         |
| `S3_PUBLIC_ENDPOINT`                      | S3 public endpoint for presigned URLs (browser-accessible)| For file uploads                      | `https://storage.example.com`                               |
