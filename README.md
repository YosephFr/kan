...
| `S3_PUBLIC_ENDPOINT`                      | Browser-accessible S3 endpoint used in presigned URLs     | When the internal S3 endpoint is not public | `https://storage.example.com`                               |
...
| `NEXT_PUBLIC_WORKSPACE_LOGOS_BUCKET_NAME` | S3 bucket name for workspace logos                        | For file uploads                            | `workspace-logos`                                           |
...
| `INSTANCE_ADMIN_EMAILS`                   | Emails allowed to manage instance whitelabel settings     | For white labelling                         | `admin@example.com`                                         |
