...
- <code>S3_ENDPOINT</code> → the endpoint used by the Kan server
- <code>S3_PUBLIC_ENDPOINT</code> → the browser-accessible endpoint used in
  presigned URLs
...
<Steps>
  <Step title="Set environment variables">
    ...
    S3_PUBLIC_ENDPOINT=http://s3.localtest.me:9000
  ...
  <Step title="Create or review Docker Compose files">
    ...
    <Note type="info">
      ...
      <ul>
        ...
        <li>
          <code>S3_ENDPOINT=http://minio:9000</code>
        </li>
        <li>
          <code>S3_PUBLIC_ENDPOINT=http://s3.localtest.me:9000</code>
        </li>
        <li>
...
<Tabs>
  ...
  <ul>
    ...
    <li><code>S3_ENDPOINT=http://minio:9000</code></li>
    <li><code>S3_PUBLIC_ENDPOINT=http://s3.localtest.me:9000</code></li>
  ...
  <ul>
    ...
    <li><code>S3_ENDPOINT=http://minio:9000</code></li>
    <li><code>S3_PUBLIC_ENDPOINT=https://s3.example.com</code></li>
...
<Accordion title="Next.js optimizer 400 — url parameter is not allowed">
  ...
  <Accordion title="Connectivity checks">
    <ul>
      ...
      <li>The browser must reach <code>S3_PUBLIC_ENDPOINT</code> when it is set.</li>
