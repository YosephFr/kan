...
interface CardCanvasPasteBatchDialogProps {
  open: boolean;
...
export function CardCanvasPasteBatchDialog({
  open,
  resourceCount,
  isImporting,
  onCancel,
  onConfirm,
}: CardCanvasPasteBatchDialogProps) {
  return (
          ...
          <div className="flex min-h-full items-center justify-center">
            <Dialog.Panel className="w-full max-w-sm rounded-lg border border-light-400 bg-light-50 p-5 shadow-xl dark:border-dark-500 dark:bg-dark-100">
              ...
              <Dialog.Title className="mt-4 text-sm font-semibold text-light-1000 dark:text-dark-1000">
                {t`Add pasted resources to a public board?`}
              </Dialog.Title>
              <Dialog.Description className="mt-2 text-xs leading-5 text-light-700 dark:text-dark-700">
                {t`This paste includes ${resourceCount} images or links. Anyone who can open this public board will be able to view those resources.`}
              </Dialog.Description>
